  ...
  <div class="q-pa-md q-gutter-sm">
    ...
    >
      <q-card class="bg-white" style="min-width: 85vw">
        <q-bar>
          {{ ' إيصال قبض رقم ' + props.receipt?.id }}
          <q-space />
          <q-btn
            dense
            flat
          ...
          <div class="col-11 q-pa-md bg-white shadow-1" ref="receiptbody">
            ...
            >
              <div class="col-12 text-center self-center q-ma-none q-pa-none">
                ...
                <p class="text-weight-bold q-ma-none">RECEIPT VOUCHER</p>
              </div>
              ...
              <div class="col-12">
                <p class="q-my-xs row justify-between">
                  <span>إستلمنا من السيد/ السيدة:</span>
              ...
              >
                <p class="q-my-xs row justify-between">
                  <span>مدفوع</span>
                  <span class="col q-px-sm underLined text-center">
                    في حساب بنك {{ props.receipt?.changed[0].account.name }}
                  </span>
                  <span>:Bank</span>
                </p>
              </div>
